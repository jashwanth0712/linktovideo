...
export function LoaderIcon({ size = 24, className = "" }: { size?: number; className?: string }) {
  return (
    ...
    >
      ...
      <path d="M12 2v4m0 12v4M2 12h4m12 0h4M4.2 4.2l2.83 2.83m8.94 0l2.83-2.83M4.2 19.8l2.83-2.83m8.94 0l2.83 2.83"></path>
    </svg>
  )
}
...
export function PlusIcon({ size = 24, className = "" }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
...
export function CopyIcon({ size = 24, className = "" }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
...
export function VolumeIcon({ size = 24, className = "" }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
