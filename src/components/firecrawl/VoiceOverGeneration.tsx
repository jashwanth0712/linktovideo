          ...
          <div className="sticky top-6 space-y-6">
            ...
            <div className="rounded-xl border border-border bg-card p-6 shadow-lg">
              ...
              <div className="space-y-2 max-h-[400px] overflow-y-auto">
                {voices.map((voice) => (
                  <button
                    ...
                    className={`w-80 text-left rounded-lg border p-3 transition-all m-1 ${
              ...
              <button
                ...
                className="w-full rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-lg transition-all hover:bg-primary/90 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 mt-7"
              >
                {isGenerating ? (
